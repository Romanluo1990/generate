package com.vip.xpf.admin.controller;

import com.github.pagehelper.PageInfo;
import com.vip.xpf.admin.controller.vo.AccountVo;
import com.vip.xpf.api.common.util.PageUtils;
import com.vip.xpf.api.controller.BaseController;
import com.vip.xpf.admin.controller.form.AccountForm;
...
public class AccountController extends BaseController<AccountService> {
  ...
  @ApiImplicitParam(
    name = "conditions",
    value = "查询条件,exapmle:[{\"fieldName\": \"id\",\"operator\": \"EQ\",\"value\":\"1\"}]",
    dataType = "String",
    paramType = "query"
  )
  public PageInfo<AccountVo> pageByConditions(
      @ModelAttribute PageSelect pageSelect, List<SelectCondition> conditions) {
