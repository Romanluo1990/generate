...
public class DaoCodeGenerator extends AbstractCodeGenerator {
	...
	private DaoCodeGenerator(DatabaseMetaData databaseMetaData, PackageBean packageBean, String tableNamePrefix,
		...
		daoImplCodeGenerator = DaoImplCodeGenerator
				.build(databaseMetaData, packageBean, tableNamePrefix, tableName, codeDir, author);
	}
	...
	public static DaoCodeGenerator build(DatabaseMetaData metaData, PackageBean packageBean, String tableNamePrefix,
			String tableName, String modelDir, String author) {
		return new DaoCodeGenerator(metaData, packageBean, tableNamePrefix, tableName, modelDir, author);
	}
}
