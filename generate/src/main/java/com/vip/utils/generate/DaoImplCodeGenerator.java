...
public class DaoImplCodeGenerator extends AbstractCodeGenerator {
	...
	private DaoImplCodeGenerator(DatabaseMetaData databaseMetaData, PackageBean packageBean, String tableNamePrefix,
	...
	public static DaoImplCodeGenerator build(
			DatabaseMetaData metaData, PackageBean packageBean, String tableNamePrefix, String tableName,
			String modelDir, String author) {
		return new DaoImplCodeGenerator(metaData, packageBean, tableNamePrefix, tableName, modelDir, author);
	}
}
