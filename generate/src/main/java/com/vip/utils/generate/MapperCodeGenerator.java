...
public class MapperCodeGenerator extends AbstractCodeGenerator {
	...
	private MapperCodeGenerator(DatabaseMetaData databaseMetaData, PackageBean packageBean, String tableNamePrefix,
			String tableName,
	...
	public static MapperCodeGenerator build(DatabaseMetaData metaData, PackageBean packageBean, String tableNamePrefix,
			String tableName,
			String modelDir, String author) {
		return new MapperCodeGenerator(metaData, packageBean, tableNamePrefix, tableName, modelDir, author);
	}
}
